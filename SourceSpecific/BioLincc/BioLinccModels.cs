...
namespace DataImporter.BioLincc
{
	...
	public class StudyRegistryId
	{
		...
		public string url { get; set; }
		public string nct_id { get; set; }
		public int sponsor_org_id { get; set; }
		public string sponsor_org { get; set; }
		public string comment { get; set; }

		public StudyRegistryId(int _study_id, string _sd_id, string _acronym, 
			                   string _url, string _nctid, string _comment)
		{
			study_id = _study_id;
			sd_id = _sd_id;
			acronym = _acronym;
	...
	public class StudyResource
	{
		...
		public StudyResource(int _study_id, string _sd_id, string _acronym, 
			            string _doc_name, int? _object_type_id, string _object_type, int? _doc_type_id,
						string _doc_type, int? _access_type_id, string _url, string _size, string _size_units)
		{
			study_id = _study_id;
			sd_id = _sd_id;
